...
export default function KamNavBar(props) {
  ...
  function pageSelected(){
    switch(currentPage) {
      case "/":
        return(
          ...
          <Link className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="Workshop">Workshop</Link>
        ...
        case "Workshop":
          return(
            ...
            <Link className="font-medium text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="" aria-current="page">Workshop</Link>
             <PlayerAuth></PlayerAuth>
          </div>
          )
      default:
    ...
    return (
        <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-slate-50 text-sm py-4 dark:bg-slate-50">
        <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
          <div className="flex items-center justify-between">
            <Link className="inline-flex items-center gap-x-2 text-xl font-semibold dark:text-white" href="#">
              <img className="w-40 h-auto" src="https://azariaimages.s3.amazonaws.com/detomata/detomata.png" alt="Logo"/> 
            </Link>
